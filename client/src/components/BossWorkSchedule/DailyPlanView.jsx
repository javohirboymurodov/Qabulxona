...
const DailyPlanView = ({
  ...
  const allItems = [
    ...
    const timeA = (a.startTime || a.scheduledTime || a.time || '00:00').replace(':', '');
    const timeB = (b.startTime || b.scheduledTime || b.time || '00:00').replace(':', '');
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{
                      ...
                      <strong style={{ fontSize: '14px' }}>
                        {item.startTime || item.scheduledTime || item.time}
